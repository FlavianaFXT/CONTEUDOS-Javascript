...
- [13 DOM - DOCUMENT OBJECT MODEL](#13-DOM---DOCUMENT-OBJECT-MODEL)
- [14 REQUISIÇÕES HTTP E APIs](#14-REQUISIÇÕES-HTTP-E-APIs)
...
- [I Métodos DOM](#I-Métodos-DOM)
	- [Métodos de seleção](#Métodos-de-seleção)
   
- [II Manipulação de Css](#II-Manipulação-de-Css)
  
- [III Manipulação de Conteúdo](#III-Manipulação-de-Conteúdo)
  
- [IV Alterando a árvore do DOM](#IV-Alterando-a-árvore-do-DOM)
	- [Criando elementos](#Criando-elementos)
	- [Adicionando elementos](#Adicionando-elementos)
	- [Excluindo elementos](#Excluindo-elementos)
   
- [V Navegando pela árvore do DOM](#V-Navegando-pela-árvore-do-DOM)
	- [Parents](#Parents)
	- [Siblings](#Siblings)
	- [Children](#Children)
	- [Eventos](#Eventos)
...
## V Navegando pela árvore do DOM
...
- [II async e await](#III-async-e-await)
	- [try/catch](#try/catch)
   
- [III Requisição a APIs](#IV-Requisição-a-APIs)
    - [Server/Client](#Server/Clien)
    - [URL, Domínio, IP e DNS](#URL,-Domínio,-IP-e-DNS)
    - [Protocolo HTTP](#Protocolo-HTTP)
    - [Request/Response](#Request/Response)
    - [API](#API)
    - [JSON](#JSON)
    	- [Estrutura JSON](#Estrutura-JSON)
	- [Acessando JSON](#Acessando-JSON)
	- [Matrizes como JSON](#Matrizes-como-JSON)
	- [Acessando JSON (matrizes)](#Acessando-JSON-(matrizes))
    - [XMLHttpRequest()](#XMLHttpRequest())
    - [fetch()](#fetch())
 
- [IV EXERCICIOS](#V-EXERCICIOS)
...
## 2. Exercitar Requisições `POST`, `PUT`, `PATCH` e `DELETE`
